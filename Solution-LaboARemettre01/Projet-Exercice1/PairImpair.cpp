...
int main() // FR :  La porte d'entrer pour le programme
{
	...
	// FR : Le programme doit afficher un message pour inviter l'utilisateur à entre un nombre entier
...
// Plan de tests
// KM : Excellent plan de tests avec des nombres variés. Il manquerait juste 0
/*
